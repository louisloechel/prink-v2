...
public class NonNumericalGeneralizer implements BaseGeneralizer{
    ...
    public Tuple2<String, Float> generalize(List<Tuple> withTuples, int pos) {
        ...
        // FIXME find out why there are wrong parameters before the first clear
...
//        System.out.println("Tree before clear 1:" + this + " - " + withTuples.toString());
//        trees.get(pos).printTree(0);

        // Remove temporary nodes
        trees.get(pos).removeTempNodes();

//        System.out.println("Tree after clear 1:" + this + " - " + withTuples.toString());
//        trees.get(pos).printTree(0);
...
//                trees.get(i).printTree(0);
    ...
    public class TreeNode implements Comparable<TreeNode>{
        ...
        public int compareTo(NonNumericalGeneralizer.TreeNode o) {
            // TODO check if this works or find a better solution or if it is needed
